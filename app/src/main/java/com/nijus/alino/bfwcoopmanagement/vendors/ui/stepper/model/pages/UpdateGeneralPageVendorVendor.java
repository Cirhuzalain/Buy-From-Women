...
import com.nijus.alino.bfwcoopmanagement.vendors.ui.stepper.ui.update.UpdateGeneralInformationVendor;

import java.util.ArrayList;

public class UpdateGeneralPageVendorVendor extends PageVendorVendor {
    public static final String GEN_KEY = "key";

    public UpdateGeneralPageVendorVendor(ModelCallbacksVendor callbacks, String title) {
        super(callbacks, title);
    }

    @Override
    public Fragment createFragment() {
        return UpdateGeneralInformationVendor.create(getKey());
    }
    ...
    public UpdateGeneralPageVendorVendor setValue(GeneralVendor generalVendor) {

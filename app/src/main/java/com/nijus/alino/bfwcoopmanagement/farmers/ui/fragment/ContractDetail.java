 ...
 * </pre>
 * <p>You activity (or fragment) needs to implement {@link ContractDetail.Listener}.</p>
 */
public class ContractDetail extends BottomSheetDialogFragment {
    ...
    public static ContractDetail newInstance(int itemCount) {
        final ContractDetail fragment = new ContractDetail();

...
import com.nijus.alino.bfwcoopmanagement.vendors.ui.stepper.ui.ServicesEquipmentFragmentVendor;

import java.util.ArrayList;

public class ServicesEquipmentPageVendorVendor extends PageVendorVendor {

    public static final String SERVICE_KEY = "service_key";

    private ServiceAccessVendor serviceAccessVendor = new ServiceAccessVendor();

    public ServicesEquipmentPageVendorVendor(ModelCallbacksVendor callbacks, String title) {
        super(callbacks, title);
    }

    @Override
    public Fragment createFragment() {
        return ServicesEquipmentFragmentVendor.create(getKey());
    }
    ...
    public ServicesEquipmentPageVendorVendor setValue(ServiceAccessVendor serviceAccessVendor) {

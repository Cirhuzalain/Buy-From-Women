...
public class BaselineFinaceInfoPage extends Page {
    ...
    public BaselineFinaceInfoPage(ModelCallbacks callbacks, String title) {
    ...
    public BaselineFinaceInfoPage setValue(BaselineFinanceInfo baselineFinanceInfo) {

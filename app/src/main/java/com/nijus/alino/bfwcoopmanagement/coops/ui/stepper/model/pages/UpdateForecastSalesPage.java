...
public class UpdateForecastSalesPage extends Page {
    ...
    public UpdateForecastSalesPage(ModelCallbacks callbacks, String title) {
    ...
    public UpdateForecastSalesPage setValue(ForecastSales forecastSales) {

...
import com.nijus.alino.bfwcoopmanagement.farmers.ui.stepper.ui.update.UpdateBaseLineFragment;

import java.util.ArrayList;

public class UpdateBaseLinePage extends Page {

    public static final String BASE_KEY = "base_key";
    private BaseLine baseLine = new BaseLine();

    public UpdateBaseLinePage(ModelCallbacks callbacks, String title) {
        super(callbacks, title);
    }

    @Override
    public Fragment createFragment() {
        return UpdateBaseLineFragment.create(getKey());
    }
    ...
    public UpdateBaseLinePage setValue(BaseLine baseLine) {

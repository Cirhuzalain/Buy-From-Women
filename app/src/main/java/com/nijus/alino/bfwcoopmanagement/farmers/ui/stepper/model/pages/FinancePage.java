...
import com.nijus.alino.bfwcoopmanagement.farmers.ui.stepper.ui.FinanceFragment;
...
public class FinancePage extends Page {
    ...
    public FinancePage(ModelCallbacks callbacks, String title) {
        super(callbacks, title);
    }

    @Override
    public Fragment createFragment() {
        return FinanceFragment.create(getKey());
    }
    ...
    public FinancePage setValue(Finance finance) {

...
public class UpdateBaselineYieldFragment extends Fragment {

    public static final String ARG_KEY = "key";
    public final String LOG_TAG = UpdateBaselineYieldFragment.class.getSimpleName();
    private String mKey;
    ...
    public UpdateBaselineYieldFragment() {
        super();
    }

    public static UpdateBaselineYieldFragment create(String key) {
        Bundle args = new Bundle();
        args.putString(ARG_KEY, key);

        UpdateBaselineYieldFragment fragment = new UpdateBaselineYieldFragment();

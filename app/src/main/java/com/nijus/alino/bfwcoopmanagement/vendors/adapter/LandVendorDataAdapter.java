...
public class LandVendorDataAdapter extends ArrayAdapter<LandInformationVendor> {

    public LandVendorDataAdapter(Context context, ArrayList<LandInformationVendor> accessToInformationArrayList) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        final LandInformationVendor landInformation = getItem(position);

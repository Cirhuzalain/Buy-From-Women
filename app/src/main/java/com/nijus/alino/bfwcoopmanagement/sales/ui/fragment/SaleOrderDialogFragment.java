...
public class SaleOrderDialogFragment extends DialogFragment implements DialogInterface.OnClickListener, View.OnClickListener {
    ...
    public void onClick(DialogInterface dialogInterface, int i) {
        if (Dialog.BUTTON_POSITIVE == i) {
            Toast.makeText(getContext(), "Save Sale Order Coming soon !!!", Toast.LENGTH_LONG).show();
        }
    }
}

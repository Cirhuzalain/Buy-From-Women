...
public class StepPagerStrip_coop extends View {
    ...
    public StepPagerStrip_coop(Context context) {
        this(context, null, 0);
    }

    public StepPagerStrip_coop(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public StepPagerStrip_coop(Context context, AttributeSet attrs, int defStyle) {
        ...
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.M) {
            ...
            mPrevTabPaint.setColor(res.getColor(R.color.step_pager_previous_tab_color, null));

            mSelectedTabPaint.setColor(res.getColor(R.color.step_pager_selected_tab_color, null));

            mSelectedLastTabPaint.setColor(res.getColor(R.color.step_pager_selected_last_tab_color, null));

            mNextTabPaint.setColor(res.getColor(R.color.step_pager_next_tab_color, null));
        }
        ...
        if (mOnPageSelectedListener != null) {
            switch (event.getActionMasked()) {
                ...
                case MotionEvent.ACTION_MOVE:
                    ...
                    if (position >= 0) {
                        mOnPageSelectedListener.onPageStripSelected2(position);
                    }
                    return true;
            }
        }
...
//        postInvalidate();
    ...
    public interface OnPageSelectedListener {
        void onPageStripSelected2(int position);
    }

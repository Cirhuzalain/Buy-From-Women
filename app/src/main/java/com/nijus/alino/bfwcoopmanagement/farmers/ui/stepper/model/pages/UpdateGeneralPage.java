...
import com.nijus.alino.bfwcoopmanagement.farmers.ui.stepper.ui.update.UpdateGeneralInformation;

import java.util.ArrayList;

public class UpdateGeneralPage extends Page {
    public static final String GEN_KEY = "key";

    public UpdateGeneralPage(ModelCallbacks callbacks, String title) {
        super(callbacks, title);
    }

    @Override
    public Fragment createFragment() {
        return UpdateGeneralInformation.create(getKey());
    }
    ...
    public UpdateGeneralPage setValue(General general) {

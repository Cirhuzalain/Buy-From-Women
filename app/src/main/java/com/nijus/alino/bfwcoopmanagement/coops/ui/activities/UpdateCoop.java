...
import com.nijus.alino.bfwcoopmanagement.coops.ui.fragment.UpdateCoopFragment;
...
public class UpdateCoop extends AppCompatActivity implements PageFragmentCallbacks, UpdateCoopFragment.OnFragmentInteractionListener {
    private UpdateWizardModel coopWizardModel = new UpdateWizardModel(this);

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_update_coop);
    }

...
import com.nijus.alino.bfwcoopmanagement.vendors.ui.stepper.ui.DemographicFragmentVendor;

import java.util.ArrayList;

public class DemographicPageVendorVendorVendor extends PageVendorVendor {

    public static final String DEMO_KEY = "key";

    private DemographicVendor demographicVendor = new DemographicVendor();

    public DemographicPageVendorVendorVendor(ModelCallbacksVendor callbacks, String title) {
        super(callbacks, title);
    }

    @Override
    public Fragment createFragment() {
        return DemographicFragmentVendor.create(getKey());
    }
    ...
    public DemographicPageVendorVendorVendor setValue(DemographicVendor demographicVendor) {

...
public class AccessToInformationVendorAdapter extends ArrayAdapter<AccessToInformationVendor> {

    public AccessToInformationVendorAdapter(Context context, ArrayList<AccessToInformationVendor> accessToInformationArrayList) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        final AccessToInformationVendor accessToInformation = getItem(position);
        ...
        if (accessToInformation != null) {
            String seasonName = "Harvest Season " + accessToInformation.getSeasonName();

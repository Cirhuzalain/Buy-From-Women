...
import com.nijus.alino.bfwcoopmanagement.farmers.ui.stepper.ui.update.UpdateLandFragment;

import java.util.ArrayList;

public class UpdateLandPage extends Page {

    public static final String LAND_KEY = "land";

    private LandInformation landInformation = new LandInformation();

    public UpdateLandPage(ModelCallbacks callbacks, String title) {
        super(callbacks, title);
    }

    @Override
    public Fragment createFragment() {
        return UpdateLandFragment.create(getKey());
    }
    ...
    public UpdateLandPage setValue(LandInformation landInformation) {

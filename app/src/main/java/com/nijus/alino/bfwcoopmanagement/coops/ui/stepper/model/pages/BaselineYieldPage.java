...
public class BaselineYieldPage extends Page {
    ...
    public BaselineYieldPage(ModelCallbacks callbacks, String title) {
    ...
    public BaselineYieldPage setValue(BaselineYield baselineYield) {

...
import com.nijus.alino.bfwcoopmanagement.farmers.ui.stepper.ui.ForecastFragment;
...
public class ForecastPage extends Page {
    ...
    public ForecastPage(ModelCallbacks callbacks, String title) {
        super(callbacks, title);
    }

    @Override
    public Fragment createFragment() {
        return ForecastFragment.create(getKey());
    }
    ...
    public ForecastPage setValue(Forecast forecast) {

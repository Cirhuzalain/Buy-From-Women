...
public class ForecastDataFarmerAdapter extends ArrayAdapter<Forecast> {

    public ForecastDataFarmerAdapter(Context context, ArrayList<Forecast> accessToInformationArrayList) {

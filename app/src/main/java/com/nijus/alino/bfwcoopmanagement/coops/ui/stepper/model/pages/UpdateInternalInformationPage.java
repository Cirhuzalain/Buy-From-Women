...
public class UpdateInternalInformationPage extends Page {

    public static final String INTERNAL_INFO_KEY = "internal_key";

    public UpdateInternalInformationPage(ModelCallbacks callbacks, String title) {
    ...
    public UpdateInternalInformationPage setValue(InternalInformation internalInformation) {

...
public class FinanceDataFarmerAdapter extends ArrayAdapter<Finance> {

    public FinanceDataFarmerAdapter(Context context, ArrayList<Finance> finances) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        final Finance finance = getItem(position);

...
import com.nijus.alino.bfwcoopmanagement.farmers.ui.stepper.ui.update.UpdateServiceFragment;

import java.util.ArrayList;

public class UpdateServicePage extends Page {

    public static final String SERVICE_KEY = "service_key";

    private ServiceAccess serviceAccess = new ServiceAccess();

    public UpdateServicePage(ModelCallbacks callbacks, String title) {
        super(callbacks, title);
    }

    @Override
    public Fragment createFragment() {
        return UpdateServiceFragment.create(getKey());
    }
    ...
    public UpdateServicePage setValue(ServiceAccess serviceAccess) {

...
public class UpdateBaselineSalesPage extends Page {
    ...
    public UpdateBaselineSalesPage(ModelCallbacks callbacks, String title) {
    ...
    public UpdateBaselineSalesPage setValue(BaselineSales baselineSales) {

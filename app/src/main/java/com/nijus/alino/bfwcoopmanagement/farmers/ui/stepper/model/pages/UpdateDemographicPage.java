...
import com.nijus.alino.bfwcoopmanagement.farmers.ui.stepper.ui.update.UpdateDemographicFragment;

import java.util.ArrayList;

public class UpdateDemographicPage extends Page {

    public static final String DEMO_KEY = "key";

    private Demographic demographic = new Demographic();

    public UpdateDemographicPage(ModelCallbacks callbacks, String title) {
        super(callbacks, title);
    }

    @Override
    public Fragment createFragment() {
        return UpdateDemographicFragment.create(getKey());
    }
    ...
    public UpdateDemographicPage setValue(Demographic demographic) {

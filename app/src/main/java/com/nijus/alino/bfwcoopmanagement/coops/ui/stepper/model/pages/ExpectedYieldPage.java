...
import com.nijus.alino.bfwcoopmanagement.coops.ui.stepper.model.pojo.BankInformation;
import com.nijus.alino.bfwcoopmanagement.coops.ui.stepper.ui.BankFragment;

import java.util.ArrayList;

public class ExpectedYieldPage extends Page {

    private BankInformation bankInformation = new BankInformation();
    public static final String BANK_KEY = "key";

    public ExpectedYieldPage(ModelCallbacks callbacks, String title) {
    ...
    public ExpectedYieldPage setValue(BankInformation bankInformation) {

...
public class StepPagerStripVendor extends View {
    ...
    public StepPagerStripVendor(Context context) {
        this(context, null, 0);
    }

    public StepPagerStripVendor(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public StepPagerStripVendor(Context context, AttributeSet attrs, int defStyle) {

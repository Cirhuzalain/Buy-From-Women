...
import com.nijus.alino.bfwcoopmanagement.vendors.ui.stepper.ui.update.UpdateLandFragmentVendor;

import java.util.ArrayList;

public class UpdateLandPageVendorVendor extends PageVendorVendor {

    public static final String LAND_KEY = "land";

    private LandInformationVendor landInformationVendor = new LandInformationVendor();

    public UpdateLandPageVendorVendor(ModelCallbacksVendor callbacks, String title) {
        super(callbacks, title);
    }

    @Override
    public Fragment createFragment() {
        return UpdateLandFragmentVendor.create(getKey());
    }
    ...
    public UpdateLandPageVendorVendor setValue(LandInformationVendor landInformationVendor) {

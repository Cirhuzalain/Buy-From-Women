...
public class AccessToInformationFarmerAdapter extends ArrayAdapter<AccessToInformation> {

    public AccessToInformationFarmerAdapter(Context context, ArrayList<AccessToInformation> accessToInformationArrayList) {

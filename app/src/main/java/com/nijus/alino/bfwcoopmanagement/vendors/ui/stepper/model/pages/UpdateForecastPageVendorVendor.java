...
import com.nijus.alino.bfwcoopmanagement.vendors.ui.stepper.ui.update.UpdateForecastFragmentVendor;

import java.util.ArrayList;

public class UpdateForecastPageVendorVendor extends PageVendorVendor {

    public static final String FORCAST_KEY = "key";

    private ForecastVendor forecastVendor = new ForecastVendor();

    public UpdateForecastPageVendorVendor(ModelCallbacksVendor callbacks, String title) {
        super(callbacks, title);
    }

    @Override
    public Fragment createFragment() {
        return UpdateForecastFragmentVendor.create(getKey());
    }
    ...
    public UpdateForecastPageVendorVendor setValue(ForecastVendor forecastVendor) {

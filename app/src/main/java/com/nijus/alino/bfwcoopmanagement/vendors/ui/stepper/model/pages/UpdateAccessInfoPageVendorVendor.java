...
import com.nijus.alino.bfwcoopmanagement.vendors.ui.stepper.ui.update.UpdateAccessInfoFragmentVendor;

import java.util.ArrayList;

public class UpdateAccessInfoPageVendorVendor extends PageVendorVendor {
    ...
    public UpdateAccessInfoPageVendorVendor(ModelCallbacksVendor callbacks, String title) {
        super(callbacks, title);
    }

    @Override
    public Fragment createFragment() {
        return UpdateAccessInfoFragmentVendor.create(getKey());
    }
    ...
    public UpdateAccessInfoPageVendorVendor setValue(AccessToInformationVendor accessToInformationVendor) {
        mData.putParcelable(ACCESSINFO_KEY, accessToInformationVendor);
        return this;
    }
